...
function hubExcerpt($value, int $limit = 150): string {
    ...
    if ($plain === '') return 'Uno spazio della rete All Social To Web.';
...
/* La rete pubblica condivide palette e geometrie della home principale. */
:root{--ink:#171917!important;--muted:#686a65!important;--line:#d8d8d2!important;--paper:#f3f0e8!important;--brand:#ee6346!important;--soft:#fff0eb!important;--shadow:0 18px 48px rgba(23,25,23,.1)!important}
.top{height:70px!important;background:rgba(243,240,232,.94)!important}.hero{position:relative!important;overflow:hidden!important;background:radial-gradient(circle at 82% 12%,rgba(200,255,114,.2) 0,transparent 25%),linear-gradient(135deg,#171917,#282b26)!important}.eyebrow{color:#c8ff72!important}.hero p{color:#c6c7c3!important}.searchbox,.profile,.article{border-radius:16px!important}.searchbox button{border-radius:10px!important}.badge.professional{background:#fff0eb!important;color:#bd422c!important}.badge.agency{background:#171917!important}
