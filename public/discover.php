...
<body>
<header class="topbar"><div class="wrap"><a class="brand" href="/" aria-label="LinkSeoWeb"><img src="/logo-cropped.png?v=3" alt=""><span>LinkSeo<i>Web</i></span></a><nav class="toplinks" aria-label="Navigazione principale"><a href="#argomenti">Esplora</a><a class="cta" href="/">Crea il tuo spazio</a></nav></div></header>
<main>
