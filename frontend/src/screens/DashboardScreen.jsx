  ...
  const navigationGroups = user?.role === 'admin' ? [
  ...
  ] : [
    {
      ...
      items: [
        ...
        { id: 'settings', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2L2 7l10 5 10-5-10-5zM2 12l10 5 10-5M2 17l10 5 10-5"></path></svg>, label: 'Temi', hint: 'Scegli il layout' },
    ...
    <div className="dashboard-shell" style={{ overflow: studioWorkspaceOpen ? 'hidden' : 'visible' }}>
      ...
      <header className="backend-header" style={{ visibility: studioWorkspaceOpen ? 'hidden' : 'visible', pointerEvents: studioWorkspaceOpen ? 'none' : 'auto' }}>
        ...
        <div className="backend-header-actions">
          <a href="/" target="_blank" rel="noopener noreferrer" className="btn btn-outline" style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
