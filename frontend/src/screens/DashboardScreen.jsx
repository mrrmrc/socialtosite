  ...
  const navigationGroups = [
    {
      ...
      items: [
        ...
        ...(user?.plan === 'base' ? [] : [{ id: 'stats', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 20V10M12 20V4M6 20v-6"></path></svg>, label: 'Statistiche', hint: 'Clic, visite e crescita' }]),
