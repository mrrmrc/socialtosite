...
const privacySections = [
  ...
  ['4. Base del trattamento', <p key="basis">Il trattamento è necessario per erogare il servizio richiesto e, per il collegamento dei social network, si basa sull’autorizzazione espressa tramite OAuth. Alcuni dati tecnici sono trattati per il legittimo interesse alla sicurezza e all’affidabilità della piattaforma. Puoi revocare l’accesso disconnettendo il canale o dalle impostazioni del relativo social network.</p>],
  ['5. Servizi esterni', <p key="providers">Per le funzioni richieste possiamo utilizzare fornitori di hosting, database, intelligenza artificiale e le API ufficiali di Meta, TikTok e Google/YouTube. Ogni fornitore tratta i dati secondo i propri termini e la propria informativa. Non vendiamo i dati personali.</p>],
...
const termsSections = [
  ...
  ['6. Piattaforme di terze parti', <p key="third">Facebook, Instagram, TikTok, YouTube, WordPress e altri servizi esterni sono indipendenti. Le loro condizioni, disponibilità, processi di revisione e limiti API si applicano ai rispettivi collegamenti e possono cambiare o interrompere alcune funzioni.</p>],
