...
const FAMILIES = [
  ...
  { id:'legal-authority', name:'Autorità professionale', category:'Professionisti', emoji:'⚖️', desc:'Sobrio e autorevole per studi legali, consulenti e professionisti.', font_heading:'Cormorant Garamond', font_body:'Inter', recipe:{hero:'split',nav:'solid',cards:'editorial',density:'balanced'}, model:'editorial-luxe', radius:'4px', shadow:'0 12px 34px rgba(22,28,38,.07)', basePalette:'burgundy' },
  ...
  { id:'boutique-signature', name:'Boutique Signature', category:'Negozi e attività', emoji:'✦', desc:'Raffinato e distintivo per atelier, prodotti e attività locali.', font_heading:'Fraunces', font_body:'DM Sans', recipe:{hero:'human',nav:'floating',cards:'product',density:'balanced'}, model:'warm-humanist', radius:'22px', shadow:'0 14px 38px rgba(45,30,25,.1)', basePalette:'ocean' },
];
