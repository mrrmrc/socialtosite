...
final class ProfileAnalyzer
{
    ...
    private static function gemini(array $input): array
    {
        ...
        $model = ProviderConfig::normalizeModel('gemini', ProviderConfig::model('gemini') ?: (self::configValue('GEMINI_MODEL', 'SOCIALTOSITE_RUNTIME_GEMINI_MODEL') ?: 'gemini-3.6-flash'));
